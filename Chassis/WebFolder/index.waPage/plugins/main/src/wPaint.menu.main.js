(function ($) {
  ...
  $.fn.wPaint.menus.main = {
    ...
    items: {
      zoom: {
        ...
        title: 'Zoom',
        index: 10,
        callback: function () { this.setMode('zoom'); }
      },     	
      undo: {
        icon: 'generic',
        title: 'Undo',
  ...
  $.extend($.fn.wPaint.cursors, {
    ...
    zoom:    {path: 'plugins/main/img/cursor-zoom.png', left: 0, top: 11.99},    
  ...
  $.fn.wPaint.extend({
     ...
     * zoom
     ****************************************/
    _drawZoomDown: function (e) { this._drawShapeDown(e); },

    _drawZoomMove: function (e) {
//      this._drawShapeMove(e);
		this._drawTranslateZoom(e);
...
//	    	this.ctx.scale(2,2);
    ...
    _drawZoomUp: function (e) {
//      	this._drawShapeZoom(e);
//     	this._addUndo();
    },
    _drawZoomWheel: function (e) {
      	this._drawShapeZoom2(e);
//     	this._addUndo();
    },    
